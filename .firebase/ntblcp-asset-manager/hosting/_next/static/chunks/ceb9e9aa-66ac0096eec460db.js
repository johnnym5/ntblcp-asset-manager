"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[728],{4764:function(e,t,i){i.d(t,{Y:function(){return e0},p:function(){return ih}});var n,r=i(7818),s=i(9504),a=i(9053),o=i(1735),l=i(2680);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${r.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e7(e,t,i=!1){if((0,r.rh)(e.app))return Promise.reject(g(e));let n="signIn",s=await e6(e,n,t),a=await e2._fromIdTokenResponse(e,n,s);return i||await e._updateCurrentUser(a.user),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
