...
import { Database, Terminal, ShieldAlert, Loader2, HardDrive, RefreshCw, Bomb, Hammer, Activity } from 'lucide-react';
          ...
          <Card className="bg-[#050505] border-2 border-white/5 rounded-[2rem] p-10">
            <CardHeader className="p-0 mb-6">
              <CardTitle className="text-xl font-black uppercase flex items-center gap-3">
                <Database className="h-5 w-5 text-primary" /> Cloud Register Pulse
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0 space-y-6">
              <div className="flex justify-between items-center text-sm font-bold">
                <span className="opacity-40 uppercase">Total Cloud Nodes</span>
          ...
          <Card className="bg-destructive/5 border-2 border-destructive/20 rounded-[2rem] p-10">
            <CardHeader className="p-0 mb-6">
              <CardTitle className="text-xl font-black uppercase flex items-center gap-3 text-destructive">
                <Bomb className="h-5 w-5" /> Maintenance Zone
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0 space-y-6">
              <p className="text-xs font-medium text-destructive/60 italic">Permanently clear all data across the global registry pulse.</p>
