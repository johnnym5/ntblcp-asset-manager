 ...
 * Hardened for responsive multi-column layouts and high-speed field use.
 */
...
import type { Asset, ConditionAuditEntry, DiscrepancyStatus } from "@/types/domain";
          ...
          <div className="p-6 sm:p-8 border-b border-white/5 bg-white/[0.02] shrink-0">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2 mt-1.5">
                ...
                {activeClassification && (
                  <Badge variant="outline" className="h-5 px-2 border-primary/20 text-primary text-[7px] font-black uppercase whitespace-nowrap">
                    ...
                    <div className="p-6 sm:p-8 rounded-[1.5rem] border-2 border-dashed border-primary/20 bg-primary/[0.02] space-y-8">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <FormField control={form.control} name="status" render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-[9px] font-black uppercase text-white/40">Audit Status</FormLabel>
                        ...
                        <FormField control={form.control} name="remarks" render={({ field }) => (
                          <FormItem className="sm:col-span-2">
                            ...
                            <FormControl><Textarea {...field} readOnly={isFieldDisabled('remarks')} className="min-h-[100px] bg-black border-2 border-white/10 rounded-2xl p-4 text-xs italic" placeholder="Document findings..." /></FormControl>
                          </FormItem>
                        )}/>
                      </div>
                    </div>
            ...
            <ScrollArea className="w-full md:w-[320px] bg-[#050505] p-6 sm:p-8 shrink-0 border-t md:border-t-0 border-white/5 hidden sm:block">
              <div className="space-y-10">
                ...
                <div className="p-6 rounded-2xl bg-white/[0.02] border-2 border-dashed border-white/10 space-y-4">
                  <div className="flex items-center gap-2 opacity-40 text-[9px] font-black uppercase tracking-widest"><Info className="h-3 w-3" /> System Logic</div>
                  <div className="space-y-2 text-[8px] uppercase">
                    ...
                    <div className="flex justify-between"><span className="text-white/20">Fidelity</span><span className="text-primary font-black">{formValues.overallFidelityScore}%</span></div>
                  </div>
                </div>
              </div>
            </ScrollArea>
