 ...
 * Phase 109: Enhanced Adaptive Scaling & Fluid Width Orchestration.
 */
    ...
    return (
        <Collapsible open={isOpen} onOpenChange={setIsOpen} className="w-full">
            <CollapsibleTrigger asChild>
                <div className='flex items-center justify-between p-6 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] bg-card border-2 shadow-2xl backdrop-blur-md mb-6 cursor-pointer hover:bg-muted/30 transition-all group'>
                    <div className="flex items-center gap-4 sm:gap-6">
                        ...
                        <div className="space-y-1">
                            <h3 className="text-xl sm:text-2xl font-black tracking-tight text-foreground uppercase leading-none">Intelligence Pulse</h3>
                    ...
                    <div className="flex items-center gap-3 sm:gap-6">
                        <div className="hidden sm:flex flex-col items-end mr-2">
                            <span className="text-[9px] font-black uppercase text-muted-foreground tracking-widest opacity-40">Coverage</span>
                            <span className="text-xl font-black text-primary leading-none">{summary.percentage}%</span>
                        </div>
                        <Badge variant="outline" className="h-10 px-6 rounded-2xl font-black uppercase text-[10px] tracking-widest border-primary/20 bg-primary/5 text-primary shadow-sm hidden xs:flex">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6 sm:gap-8">
                        ...
                        <Card className="bg-muted/10 border-2 border-dashed border-border/40 rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-none">
                            <CardHeader className="p-6 bg-muted/20 border-b border-dashed">
                                <CardTitle className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground flex items-center gap-3">
                                    <Activity className="h-4 w-4 text-primary" /> Temporal Pulse
                                </CardTitle>
                            </CardHeader>
                        ...
                        <Card className="bg-muted/10 border-2 border-dashed border-border/40 rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-none flex-1">
                            ...
                            <CardContent className="p-8 flex flex-col justify-center items-center text-center space-y-4">
                                ...
                                <div className="space-y-1">
                                    <p className="text-2xl font-black tracking-tighter">STABLE</p>
