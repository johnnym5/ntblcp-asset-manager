          ...
          <div className="flex items-center gap-3">
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>Generate new random audit samples</TooltipContent>
              </Tooltip>
            </TooltipProvider>
            ...
            <Button 
              ...
              className="rounded-xl h-10 w-10 bg-muted border border-border text-muted-foreground hover:text-primary transition-colors shadow-sm"
            >
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <Card className="bg-card border-border rounded-[2.5rem] overflow-hidden shadow-2xl">
                <CardContent className="p-6 space-y-3">
                  <Button onClick={() => setActiveView('REGISTRY')} variant="outline" className="w-full h-12 rounded-xl border-border font-black uppercase text-[10px] tracking-widest gap-4 justify-start px-5 group hover:border-primary/40">
                    <FolderOpen className="h-4 w-4 text-primary group-hover:scale-110 transition-transform" /> Asset Hub
                  </Button>
                  <Button onClick={() => { setGroupsViewMode('category'); setActiveView('GROUPS'); }} variant="outline" className="w-full h-12 rounded-xl border-border font-black uppercase text-[10px] tracking-widest gap-4 justify-start px-5 hover:border-primary/40">
                    <LayoutGrid className="h-4 w-4 text-primary" /> Browse Folders
                  </Button>
                  <Button onClick={() => { setGroupsViewMode('condition'); setActiveView('GROUPS'); }} variant="outline" className="w-full h-12 rounded-xl border-border font-black uppercase text-[10px] tracking-widest gap-4 justify-start px-5 hover:border-primary/40">
                    <Activity className="h-4 w-4 text-primary" /> Asset Conditions
                  </Button>
                  <Button onClick={() => setActiveView('ANOMALIES')} variant="outline" className="w-full h-12 rounded-xl border-border font-black uppercase text-[10px] tracking-widest gap-4 justify-start px-5 hover:border-primary/40">
                    <SearchCode className="h-4 w-4 text-primary" /> Pattern Anomalies
                  </Button>
                  {isAdmin && (
                    <Button onClick={() => setActiveView('SETTINGS')} variant="outline" className="w-full h-12 rounded-xl border-border font-black uppercase text-[10px] tracking-widest gap-4 justify-start px-5 hover:border-primary/40">
