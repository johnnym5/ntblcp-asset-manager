...
export const AUTHORIZED_USERS: AuthorizedUser[] = [
  ...
  { displayName: "Mrs Victoria", loginName: "mrs victoria", states: ["Osun"], isAdmin: false, password: "0000", passwordChanged: false },
  ...
  { displayName: "Franscisca", loginName: "franscisca", states: ["Ebonyi"], isAdmin: false, password: "0000", passwordChanged: false },
  { displayName: "Sani", loginName: "sani", states: ["Borno"], isAdmin: false, password: "0000", passwordChanged: false },
  { displayName: "Mrs Angelina", loginName: "mrs angelina", states: ["Yobe"], isAdmin: false, password: "0000", passwordChanged: false },
  { displayName: "Louis", loginName: "louis", states: ["Katsina"], isAdmin: false, password: "0000", passwordChanged: false },
  { displayName: "Mrs Angabs", loginName: "mrs angabs", states: ["Zamfara"], isAdmin: false, password: "0000", passwordChanged: false },
  ...
  { displayName: "Mrs Bala", loginName: "mrs bala", states: ["Nasarawa"], isAdmin: false, password: "0000", passwordChanged: false },
];
