...
export const AUTHORIZED_USERS: AuthorizedUser[] = [
  ...
  { displayName: "Steve", loginName: "steve", states: ["Rivers", "Kano", "South South Zonal Store", "North West Zonal Store"], isAdmin: true, password: "0000", passwordChanged: false, canAddAssets: true, canEditAssets: true },
  ...
  { displayName: "Bassey", loginName: "bassey", states: ["Bauchi", "North East Zonal Store"], isAdmin: false, password: "0000", passwordChanged: false, canAddAssets: false, canEditAssets: false },
  ...
  { displayName: "Chidera", loginName: "chidera", states: ["Enugu", "South East Zonal Store"], isAdmin: false, password: "0000", passwordChanged: false, canAddAssets: false, canEditAssets: false },
  ...
  { displayName: "Chidozie", loginName: "chidozie", states: ["Niger", "North Central Zonal Store"], isAdmin: false, password: "0000", passwordChanged: false, canAddAssets: false, canEditAssets: false },
  ...
  { displayName: "Ude", loginName: "ude", states: ["Oyo", "South West Zonal Store"], isAdmin: false, password: "0000", passwordChanged: false, canAddAssets: false, canEditAssets: false },
