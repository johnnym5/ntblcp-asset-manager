...
// This object now defines the complete structure for each sheet, including the definitive
// list of headers to look for and the default display configuration.
export const HEADER_DEFINITIONS: Record<string, SheetDefinition> = {
  'NTBLCP-TB-FAR': {
    ...
    displayFields: [
      ...
      { key: 'description', label: 'Asset Description', table: false, quickView: true },
      ...
      { key: 'grnNo', label: 'GRN No.', table: false, quickView: false },
      { key: 'pvNo', label: 'PV No.', table: false, quickView: false },
      { key: 'costNgn', label: 'Cost (NGN)', table: false, quickView: false },
      { key: 'costUsd', label: 'Cost (USD)', table: false, quickView: false },
      ...
      { key: 'verifiedDate', label: 'Verified Date', table: false, quickView: true },
  ...
  'PDX-C19RM': {
    ...
    displayFields: [
      ...
      { key: 'grant', label: 'Grant', table: false, quickView: false },
      { key: 'usefulLifeYears', label: 'Useful Life (Years)', table: false, quickView: false },
      { key: 'imei', label: 'IMEI', table: false, quickView: false },
      { key: 'verifiedStatus', label: 'Verified Status', table: true, quickView: true },
      { key: 'verifiedDate', label: 'Verified Date', table: false, quickView: true },
      { key: 'lastModified', label: 'Last Modified', table: false, quickView: true },
      { key: 'lastModifiedBy', label: 'Modified By', table: false, quickView: true },
  ...
  'IHVN-GF N-THRIP': {
    ...
    displayFields: [
      ...
      { key: 'assetClass', label: 'CLASSIFICATION', table: false, quickView: true },
      { key: 'serialNumber', label: 'ASSET SERIAL NUMBERS', table: true, quickView: true },
      { key: 'modelNumber', label: 'MODEL NUMBERS', table: false, quickView: true },
      { key: 'qty', label: 'QTY', table: false, quickView: true },
      { key: 'lga', label: 'LOCATION', table: true, quickView: true },
      { key: 'site', label: 'SITE', table: false, quickView: true },
      { key: 'dateReceived', label: 'YEAR OF PURCHASE', table: false, quickView: false },
      { key: 'costNgn', label: 'COST (NGN)', table: false, quickView: false },
      { key: 'grant', label: 'GRANT', table: false, quickView: false },
      { key: 'assignee', label: 'Assignee', table: true, quickView: false },
      { key: 'condition', label: 'Condition', table: false, quickView: true },
      { key: 'remarks', label: 'Remarks', table: false, quickView: true },
      { key: 'verifiedStatus', label: 'Verified Status', table: true, quickView: true },
      { key: 'verifiedDate', label: 'Verified Date', table: false, quickView: true },
