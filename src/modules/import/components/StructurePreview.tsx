                  ...
                  <div className="flex items-center gap-6">
                    {selectable && (
                      <button 
                        ...
                        className={cn(
                          "h-10 w-10 rounded-xl border-2 flex items-center justify-center transition-all shadow-lg",
                          isSelected ? "bg-primary border-primary text-black" : "border-white/10 hover:border-white/30"
                        )}
                      >
                        {isSelected ? <Check className="h-6 w-6" /> : <Circle className="h-4 w-4 opacity-20" />}
                      </button>
                    )}
